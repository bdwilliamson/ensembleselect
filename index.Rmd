...
```{r results-a-auc, echo = FALSE, fig.show = "hold", out.width = "140%", fig.align = "center"}
knitr::include_graphics(c(
...
```{r results-a-sens-spec, echo = FALSE, fig.show = "hold", out.width = "140%", fig.align = "center"}
knitr::include_graphics(c(
...
```{r results-b-auc, echo = FALSE, fig.show = "hold", out.width = "140%", fig.align = "center"}
knitr::include_graphics(c(
...
```{r results-b-sens-spec, echo = FALSE, fig.show = "hold", out.width = "140%", fig.align = "center"}
knitr::include_graphics(c(
